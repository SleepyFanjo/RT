...
static void		get_text_sequel(t_param *param, t_env e)
{
	T5.file = "./textures/5.xpm";
	T5.img = mlx_xpm_file_to_image(e.mlx, T5.file, &T5.size_x, &T5.size_y);
	if (T5.img == NULL)
		exit(0);
	T5.data = mlx_get_data_addr(T5.img, &T5.bpp, &T5.sizeline, &T5.endian);
	T6.file = "./textures/6.xpm";
	T6.img = mlx_xpm_file_to_image(e.mlx, T6.file, &T6.size_x, &T6.size_y);
	if (T6.img == NULL)
		exit(0);
	T6.data = mlx_get_data_addr(T6.img, &T6.bpp, &T6.sizeline, &T6.endian);
	T7.file = "./textures/7.xpm";
	T7.img = mlx_xpm_file_to_image(e.mlx, T7.file, &T7.size_x, &T7.size_y);
	if (T7.img == NULL)
		exit(0);
	T7.data = mlx_get_data_addr(T7.img, &T7.bpp, &T7.sizeline, &T7.endian);
	T8.file = "./textures/8.xpm";
	T8.img = mlx_xpm_file_to_image(e.mlx, T8.file, &T8.size_x, &T8.size_y);
	if (T8.img == NULL)
		exit(0);
